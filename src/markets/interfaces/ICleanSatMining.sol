...
interface ICleanSatMining {
     ...
     *
     */
    event TokenWhitelistWithTypeToggled(address[] indexed tokens, TokenType[] indexed types);
     ...
     *
     */
    function updateOffer(uint256 offerId, uint256 price, uint256 amount) external;
     ...
     *
     */
    function buy(uint256 offerId, uint256 price, uint256 amount) external;
     ...
     *
     */
    function tokenInfo(address tokenAddress) external view returns (uint256, string memory, string memory);
     ...
     *
     */
    function toggleWhitelistWithType(address[] calldata tokens, TokenType[] calldata types) external;
